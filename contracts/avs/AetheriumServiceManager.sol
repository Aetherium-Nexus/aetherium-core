...
contract AetheriumServiceManager is ECDSAServiceManagerBase, PackageVersioned {
    // ============ Libraries ============
    ...
    /**
     * @notice Initializes the AetheriumServiceManager contract with the owner address
     */
    ...
    function startUnenrollment(IRemoteChallenger challenger) public {
        ...
        require(
            ...
            "AetheriumServiceManager: challenger isn't enrolled"
        );
        ...
        require(
            exists &&
                ...
                enrollment.unenrollmentStartBlock +
                    challenger.challengeDelayBlocks(),
            "AetheriumServiceManager: Invalid unenrollment"
        );
