...
/**
 * @title Aetherium ERC20 Token Collateral with deposits collateral to a vault, the yield goes to the owner
 * @author ltyu
 */
contract AetERC4626OwnerCollateral is AetERC20Collateral {
    ...
    // Nonce for the rate update, to ensure sequential updates (not necessary for Owner variant but for compatibility with AetERC4626)
    ...
    constructor(
        ...
        uint256 _scale,
        address _mailbox
    ) AetERC20Collateral(_vault.asset(), _scale, _mailbox) {
        vault = _vault;
    }
