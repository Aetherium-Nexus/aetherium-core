...
import {AetERC20} from "../AetERC20.sol";
...
/**
 * @title Aetherium ERC20 Token Router that extends ERC20 with remote transfer functionality.
 * @author Abacus Works
 * @dev Supply on each chain is not constant but the aggregate supply across all chains is.
 */
contract FastAetERC20 is FastTokenRouter, AetERC20 {
    constructor(
        uint8 __decimals,
        uint256 _scale,
        address _mailbox
    ) AetERC20(__decimals, _scale, _mailbox) {}
    ...
    function balanceOf(
        address _account
    ) public view virtual override(AetERC20, TokenRouter) returns (uint256) {
