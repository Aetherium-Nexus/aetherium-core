...
import {AetERC721} from "../AetERC721.sol";
...
/**
 * @title Aetherium ERC721 Token that extends ERC721URIStorage with remote transfer and URI relay functionality.
 * @author Abacus Works
 */
contract AetERC721URIStorage is AetERC721, ERC721URIStorageUpgradeable {
    constructor(address _mailbox) AetERC721(_mailbox) {}
    ...
    function balanceOf(
        ...
        public
        view
        override(AetERC721, ERC721Upgradeable, IERC721Upgradeable)
        returns (uint256)
    {
        return AetERC721.balanceOf(account);
    }

    /**
     * @return _tokenURI The URI of `_tokenId`.
     * @inheritdoc AetERC721
     */
    function _transferFromSender(
        uint256 _tokenId
    ) internal override returns (bytes memory _tokenURI) {
        _tokenURI = bytes(tokenURI(_tokenId)); // requires minted
        AetERC721._transferFromSender(_tokenId);
    }
    ...
    function _transferTo(
        ...
        AetERC721._transferTo(_recipient, _tokenId, _tokenURI);
