...
contract CircleBridgeAdapter is ILiquidityLayerAdapter, Router {
    ...
    /// @notice Aetherium domain => Circle domain.
    ...
    /// Ethereum or unknown.
    mapping(uint32 => uint32) public aetheriumDomainToCircleDomain;
    ...
    /**
     * @notice Emitted when the Aetherium domain to Circle domain mapping is updated.
     * @param aetheriumDomain The Aetherium domain.
     * @param circleDomain The Circle domain.
     */
    event DomainAdded(uint32 indexed aetheriumDomain, uint32 circleDomain);
    ...
    function sendTokens(
        ...
        uint32 _circleDomain = aetheriumDomainToCircleDomain[
            _destinationDomain
        ];
    ...
    function receiveTokens(
        ...
        uint32 _originCircleDomain = aetheriumDomainToCircleDomain[
            _originDomain
        ];
    ...
    function addDomain(
        ...
        aetheriumDomainToCircleDomain[_aetheriumDomain] = _circleDomain;

        emit DomainAdded(_aetheriumDomain, _circleDomain);
    }
