...
import {TestAetheriumServiceManager} from "../../contracts/test/avs/TestAetheriumServiceManager.sol";
import {TestRemoteChallenger} from "../../contracts/test/TestRemoteChallenger.sol";

import {EigenlayerBase} from "./EigenlayerBase.sol";

contract AetheriumServiceManagerTest is EigenlayerBase {
    TestAetheriumServiceManager internal _hsm;
    ...
    function setUp() public {
        ...
        _hsm = new TestAetheriumServiceManager(
    ...
    function test_updateAVSMetadataURI() public {
        ...
        emit AVSMetadataURIUpdated(address(_hsm), "aetheriumAVS");
        _hsm.updateAVSMetadataURI("aetheriumAVS");
    }
    ...
    function testFuzz_startUnenrollment_revert(uint8 numOfChallengers) public {
        ...
        vm.expectRevert("AetheriumServiceManager: challenger isn't enrolled");
    ...
    function testFuzz_freezeOperator_duringEnrollment(
        ...
        for (uint256 i = 0; i < unenrollableChallengers.length; i++) {
            vm.expectRevert(
                "AetheriumServiceManager: Operator not enrolled in challenger"
            );
    ...
    function testFuzz_deregisterOperator_withEnrollment() public {
        ...
        vm.expectRevert("AetheriumServiceManager: Invalid unenrollment");
        _ecdsaStakeRegistry.deregisterOperator();
