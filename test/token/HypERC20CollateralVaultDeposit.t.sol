...
import {AetERC4626OwnerCollateral} from "../../contracts/token/extensions/AetERC4626OwnerCollateral.sol";
import "../../contracts/test/ERC4626/ERC4626Test.sol";

contract AetERC4626OwnerCollateralTest is AetTokenTest {
    using TypeCasts for address;

    uint256 constant DUST_AMOUNT = 1e11;
    AetERC4626OwnerCollateral internal erc20CollateralVaultDeposit;
    ERC4626Test vault;
    ...
    function setUp() public override {
        ...
        AetERC4626OwnerCollateral implementation = new AetERC4626OwnerCollateral(
                vault,
                SCALE,
        ...
        TransparentUpgradeableProxy proxy = new TransparentUpgradeableProxy(
            ...
            abi.encodeWithSelector(
                AetERC4626OwnerCollateral.initialize.selector,
                address(address(noopHook)),
                address(igp),
                address(this)
            )
        );
        localToken = AetERC4626OwnerCollateral(address(proxy));
        erc20CollateralVaultDeposit = AetERC4626OwnerCollateral(
            address(localToken)
        );
        ...
        public
    {
        ...
        assertEq(AetERC4626(address(remoteToken)).exchangeRate(), 1e10);
        assertEq(AetERC4626(address(remoteToken)).previousNonce(), 1);
    }
