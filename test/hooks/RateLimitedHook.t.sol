...
contract RateLimitedHookTest is Test {
    ...
    AetERC20Collateral warpRouteLocal;
    AetERC20 warpRouteRemote;
    ...
    function setUp() external {
        ...
        warpRouteLocal = new AetERC20Collateral(
            address(token),
            SCALE,
        ...
        warpRouteRemote = new AetERC20(DECIMALS, SCALE, address(remoteMailbox));
