...
import {MockAetheriumEnvironment} from "../contracts/mock/MockAetheriumEnvironment.sol";

import {TypeCasts} from "../contracts/libs/TypeCasts.sol";

contract LiquidityLayerRouterTest is Test {
    MockAetheriumEnvironment testEnvironment;
    ...
    function setUp() public {
        ...
        testEnvironment = new MockAetheriumEnvironment(
            originDomain,
            destinationDomain
        );
    ...
    function testDispatchWithTokensTransfersOnDestination() public {
        ...
        bytes32 nonceId = messageTransmitter.hashSourceAndNonce(
            destinationBridgeAdapter.aetheriumDomainToCircleDomain(
                originDomain
            ),
